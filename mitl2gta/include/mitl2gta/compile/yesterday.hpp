...
class compiled_untimed_yesterday_t final
...
public:
  ...
  compiled_untimed_yesterday_t(compiled_untimed_yesterday_t const &) = default;
  compiled_untimed_yesterday_t(compiled_untimed_yesterday_t &&) = default;
  compiled_untimed_yesterday_t &
  operator=(compiled_untimed_yesterday_t const &) = default;
  compiled_untimed_yesterday_t &
  operator=(compiled_untimed_yesterday_t &&) = default;
...
class compiled_timed_yesterday_t
    : public mitl2gta::compilation::unary_node_t,
...
public:
  ...
  compiled_timed_yesterday_t(compiled_timed_yesterday_t const &) = default;
  compiled_timed_yesterday_t(compiled_timed_yesterday_t &&) = default;
  compiled_timed_yesterday_t &
  operator=(compiled_timed_yesterday_t const &) = default;
  compiled_timed_yesterday_t &
  operator=(compiled_timed_yesterday_t &&) = default;
