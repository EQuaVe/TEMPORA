...
#define E_DB(x, y) tchecker::dbm::extended::db((x), (y))
...
TEST_CASE("operations for extended algebra", "[tchecker::dmb::extended::db]")
{
  tchecker::dbm::extended::db_t le_1 = E_DB(DB_LE, 1); // <= 1
  tchecker::dbm::extended::db_t lt_1 = E_DB(DB_LT, 1); // < 1

  SECTION("sum")
  {
    // <=-inf + <=inf = <=inf
    REQUIRE(tchecker::dbm::extended::sum(tchecker::dbm::extended::LE_MINUS_INFINITY, tchecker::dbm::extended::LE_INFINITY) ==
            tchecker::dbm::extended::LE_INFINITY);

    // <=-inf + <inf = <=-inf
    REQUIRE(tchecker::dbm::extended::sum(tchecker::dbm::extended::LE_MINUS_INFINITY, tchecker::dbm::extended::LT_INFINITY) ==
            tchecker::dbm::extended::LE_MINUS_INFINITY);

    // <=-inf + <=1 = <=-inf
    REQUIRE(tchecker::dbm::extended::sum(tchecker::dbm::extended::LE_MINUS_INFINITY, le_1) ==
            tchecker::dbm::extended::LE_MINUS_INFINITY);

    // <=-inf + <1 = <=-inf
    REQUIRE(tchecker::dbm::extended::sum(tchecker::dbm::extended::LE_MINUS_INFINITY, lt_1) ==
            tchecker::dbm::extended::LE_MINUS_INFINITY);
  }
  ...
  {
    // <-inf < <=-inf < <c < <=c < <inf < <=inf
    REQUIRE(tchecker::dbm::extended::LT_MINUS_INFINITY < tchecker::dbm::extended::LE_MINUS_INFINITY);
    REQUIRE(tchecker::dbm::extended::LE_MINUS_INFINITY < lt_1);
    REQUIRE(lt_1 < le_1);
    REQUIRE(le_1 < tchecker::dbm::extended::LT_INFINITY);
    REQUIRE(tchecker::dbm::extended::LT_INFINITY < tchecker::dbm::extended::LE_INFINITY);
  }
}
