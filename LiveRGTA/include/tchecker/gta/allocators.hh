...
#ifndef TCHECKER_GTA_ALLOCATORS_HH
#define TCHECKER_GTA_ALLOCATORS_HH
...
/*!
 \file allocators.hh
 \brief Allocators of states and transitions for generalized timed automata
 */
...
/*!
 ...
 \tparam STATE : type of states, should inherit from tchecker::gta::state_t and should be a tchecker::make_shared object
 \brief Pool allocator for states of generalized timed automata that can be extended to allocate more complex states
 */
template <class STATE> class state_pool_allocator_t : private tchecker::ta::details::state_pool_allocator_t<STATE> {
  static_assert(std::is_base_of<tchecker::gta::state_t, STATE>::value, "");
...
/*!
 ...
 \tparam TRANSITION : type of transitions, should inherit from tchecker::gta::transition_t and should be a tchecker::make_shared
 object
 \brief Pool allocator for transitions of generalized timed automata that can be extended to allocate more complex transitions
 */
template <class TRANSITION>
class transition_pool_allocator_t : private tchecker::ta::details::transition_pool_allocator_t<TRANSITION> {
  static_assert(std::is_base_of<tchecker::gta::transition_t, TRANSITION>::value, "");
...
/*!
 \class state_pool_allocator_t
 \brief Pool allocator for states of generalized timed automata
 */
class state_pool_allocator_t final : public tchecker::gta::details::state_pool_allocator_t<tchecker::gta::shared_state_t> {
public:
  using tchecker::gta::details::state_pool_allocator_t<tchecker::gta::shared_state_t>::state_pool_allocator_t;
};

/*!
 \class transition_pool_allocator_t
 \brief Pool allocator for transitions of generalized timed automata
 */
class transition_pool_allocator_t final
    : public tchecker::gta::details::transition_pool_allocator_t<tchecker::gta::shared_transition_t> {
public:
  using tchecker::gta::details::transition_pool_allocator_t<tchecker::gta::shared_transition_t>::transition_pool_allocator_t;
};
...
#endif // TCHECKER_GTA_ALLOCATORS_HH
