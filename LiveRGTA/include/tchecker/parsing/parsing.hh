...
/*!
 \brief Parser for GTA programs
 \param gta_prog_context : context (location in file, etc) for string to parse
 \param gta_prog_str : string to parse
 \return The gta program read from gta_prog_str, nullptr if parsing failed
 \post All errors and warnings have been reported on std::cerr
 \note gta_prog_context is used in error messages to provide context
 information regarding stmt_str. It is ignored if empty
 */
