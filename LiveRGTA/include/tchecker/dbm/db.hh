...
// We currently only have safe db implementation for db over extended algebra
namespace extended {

/*!
 \brief Output a difference bound over extended algebra
 \param os : output stream
...
using tchecker::dbm::comparator_str;
