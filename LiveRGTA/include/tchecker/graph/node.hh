...
/*!
 \struct node_gtazg_state_t
 \brief Graph node that points to a state of a gta zone graph
 */
struct node_gtazg_state_t {
  /*!
   \brief Constructor
   ...
   \post this node keeps a shared pointer to s
  */
  node_gtazg_state_t(tchecker::gtazg::state_sptr_t const & s);
  ...
  /*!
   ...
   \post this node keeps a shared pointer to s
   */
  node_gtazg_state_t(tchecker::gtazg::const_state_sptr_t const & s);

  /*!
  \brief Accessor
  \return shared pointer to zone graph state in this node
  */
  inline tchecker::gtazg::const_state_sptr_t state_ptr() const { return _state; }

  /*!
  \brief Accessor
  \return zone graph state in this node
  */
  inline tchecker::gtazg::state_t const & state() const { return *_state; }

private:
  tchecker::gtazg::const_state_sptr_t _state; /*!< State of the zone graph */
};
