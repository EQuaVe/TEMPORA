...
std::ostream & output(std::ostream & os, tchecker::dbm::extended::db_t const & db)
{
  if (db == tchecker::dbm::extended::LT_INFINITY)
    os << "<inf";
  else if (db == tchecker::dbm::extended::LE_INFINITY)
    os << "<=inf";
  else if (db == tchecker::dbm::extended::LT_MINUS_INFINITY)
    os << "<-inf";
  else if (db == tchecker::dbm::extended::LE_MINUS_INFINITY)
    os << "<=-inf";
  else
    os << tchecker::dbm::comparator_str(db) << tchecker::dbm::value(db);
  return os;
