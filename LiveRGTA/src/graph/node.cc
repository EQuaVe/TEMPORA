...
node_gtazg_state_t::node_gtazg_state_t(tchecker::gtazg::state_sptr_t const & s) : _state(s) {}

node_gtazg_state_t::node_gtazg_state_t(tchecker::gtazg::const_state_sptr_t const & s) : _state(s) {}
