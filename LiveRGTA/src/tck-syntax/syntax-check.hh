...
/*!
 \brief Check generalized timed automaton syntax from a system declaration
 \param os : output stream
 \param sysdecl : system declaration
 \return true if sysdecl contains a syntactically correct declaration of a
 system of generalized timed automata, false otherwise
 \post syntax errors have been reported to os
 warning messages have been issued to os
*/
bool syntax_check_gta(std::ostream & os, tchecker::parsing::system_declaration_t const & sysdecl);
